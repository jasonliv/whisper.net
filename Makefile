...
CUDA_ARCH12=61-real;75-real;80-real;86-real;89-real;90-virtual;120a-real;120a-virtual
CUDA_ARCH13=75-real;80-real;86-real;89-real;90-virtual;120a-real;120a-virtual
CUDA_SUPPORT12=-DGGML_CUDA=ON -DCMAKE_CUDA_ARCHITECTURES="$(CUDA_ARCH12)" -DGGML_CUDA_COMPRESSION_MODE=size
CUDA_SUPPORT13=-DGGML_CUDA=ON -DCMAKE_CUDA_ARCHITECTURES="$(CUDA_ARCH13)" -DGGML_CUDA_COMPRESSION_MODE=size
...
linux_x64_cuda:
	...
	cmake -S . -B build/linux-x64-cuda -DCMAKE_C_COMPILER=x86_64-linux-gnu-gcc -DCMAKE_CXX_COMPILER=x86_64-linux-gnu-g++ -DCMAKE_SYSTEM_NAME=Linux -DCMAKE_SYSTEM_PROCESSOR=x86_64 $(CUDA_SUPPORT13) $(AVX_SUPPORT)
...
linux_x64_cuda12:
	...
	cmake -S . -B build/linux-x64-cuda12 -DCMAKE_C_COMPILER=x86_64-linux-gnu-gcc -DCMAKE_CXX_COMPILER=x86_64-linux-gnu-g++ -DCMAKE_SYSTEM_NAME=Linux -DCMAKE_SYSTEM_PROCESSOR=x86_64 $(CUDA_SUPPORT12) $(AVX_SUPPORT)
